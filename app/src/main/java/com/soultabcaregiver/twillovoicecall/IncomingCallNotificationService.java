package com.soultabcaregiver.twillovoicecall;
    ...
    private Notification buildNotification(String text, PendingIntent pendingIntent, Bundle extras,
        ...
        Notification.Builder builder =
                new Notification.Builder(getApplicationContext(), channelId)
                        ...
                        .setExtras(extras)
                        .setAutoCancel(true)
                        .addAction(android.R.drawable.ic_menu_delete, getString(R.string.calls_end_result_declined), piRejectIntent)
                        .addAction(android.R.drawable.ic_menu_call, getString(R.string.calls_notification_accept), piAcceptIntent)
