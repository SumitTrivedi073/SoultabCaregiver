...
public class SendbirdCallService extends Service {
	...
	public static final String EXTRA_CALL_TO_CHANNEL = "call_to_channel";
	
	public static final String EXTRA_CALLING_FROM_CHAT = "calling_from_chat";
	...
	public static void dial(Context context, String doDialWithCalleeId, String name,
		...
		serviceData.channelUrl = channelUrl;
		serviceData.isCallingFromChat = isCallingFromChat;
	...
	private static void startService(Context context, ServiceData serviceData) {
		...
		if (context != null) {
			...
			intent.putExtra(EXTRA_CALL_TO_CHANNEL, serviceData.channelUrl);
			intent.putExtra(EXTRA_CALLING_FROM_CHAT, serviceData.isCallingFromChat);
	...
	private Notification getNotification(@NonNull ServiceData serviceData) {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
			...
			NotificationChannel channel = new NotificationChannel(channelId, channelName,
					serviceData.isHeadsUpNotification ? NotificationManager.IMPORTANCE_LOW :
