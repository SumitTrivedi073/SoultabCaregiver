...
import static com.soultabcaregiver.sendbird_calls.SendbirdCallService.EXTRA_CALL_TO_CHANNEL;
...
public class IncomingCallActivity extends BaseActivity {
	...
	private Intent getCallActivityIntent() {
		...
		intent.putExtra(EXTRA_CALL_TO_CHANNEL, mServiceData.channelUrl);
		intent.putExtra(EXTRA_CALLING_FROM_CHAT, false);
