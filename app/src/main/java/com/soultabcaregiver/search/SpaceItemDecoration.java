...
public class SpaceItemDecoration extends RecyclerView.ItemDecoration {
	...
	private static final boolean DEFAULT_ADD_SPACE_BELOW_LAST_ITEM = true;
	...
	public void getItemOffsets(Rect outRect, View view, RecyclerView parent,
		...
		if (addSpaceAboveFirstItem && parent.getChildLayoutPosition(
				view) < 1 || parent.getChildLayoutPosition(view) >= 1) {
		...
		if (addSpaceBelowLastItem && parent.getChildAdapterPosition(view) == getTotalItemCount(
				parent) - 1) {
			if (getOrientation(parent) == LinearLayoutManager.VERTICAL) {
