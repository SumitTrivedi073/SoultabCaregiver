...
public class PushUtils {
	...
	public static void unregisterPushHandler(
			SendBirdPushHelper.OnPushRequestCompleteListener listener) {
		SendBirdPushHelper.unregisterPushHandler(listener);
	}
	
	public static void setPushNotification(boolean enable,
	                                       SendBird.SetPushTriggerOptionHandler handler) {
		SendBird.PushTriggerOption option =
				enable ? SendBird.PushTriggerOption.ALL : SendBird.PushTriggerOption.OFF;
